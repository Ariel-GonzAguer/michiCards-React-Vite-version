    ...
    <section className={styles.guide} >
      ...
      <details>
        ...
        <ul>
          ...
          <li><FontAwesomeIcon icon={faMobileScreen} /> The app is designed to be used on mobile devices with small size screens. On laptops, desktop computers and tablets <span className={styles.hey}>THE IMAGES COULD LOOK KINDA WEIRD, LIKE VERY SMALL.</span></li>
      ...
      <details>
        ...
        <span className={styles.hey}> The only essential requirement on the form to create the card is to write Michi's
          name.</span><br /><br />
        ...
        <details>
          ...
          You can take a picture with your device pressing the 'Load your own picture' button.<br />
        ...
        <details>
          ...
          Just press 'Get a random picture' button to see the kitty cat that will be in the new Michi Card.
        </details>
        <span className={styles.hey2}> If you dont load a picture or preview an image, the new Michi Card will show the image section empty.<br /> The last option You choose for the picture, is the one that will display.</span><br /><br />
        Once the above information is complete, press the 'Ready!' button to see the new created Michi Card <FontAwesomeIcon icon={faShieldCat} /><br />
        Now You can take a screenshot to save the new Michi Card on your device!<br /><br />
        <span className={styles.hey}>Note:</span> to create a New Michi Card, after created one, press the Michi Cards icon <FontAwesomeIcon icon={faShieldCat} /> to go back to Home Page.
      </details>
      ...
      <details>
        ...
        'regulars', but its background is Red and a 'Half Star' icon appears next to the Michi's name <FontAwesomeIcon icon={faStarHalfStroke} /><br />
