...
export default function UserGuide() {
  ...
  return (
    <section className={styles.guide}>
      ...
      <p>
        Here you could find the answer of all of your questions in life... if
        the questions are related with Michi Cards
      </p>
      ...
      <details>
        ...
        This section will guide you through easy use of the app.
        <br />
        To create a New Michi Card, press the 'Create Michi Card{" "}
        <FontAwesomeIcon icon={faCat} /> ' option.
        <br />
        <br />
        ...
        <br />
        <br />
        The name must be a maximum of 11 characters. Choose the name that seems
        funniest or cutest to you.
        <br />
        You can write a description about the feline in the 'How is the Michi'
        section, in 125 characters (including spaces) or less. If you don't
        write anything, no problem, some feline deity will grant the Michi they
        divine personality.
        <br />
        ...
        <details>
          ...
          picture' button.
          <br />
          Try to put the face of your Michi in the upper section of the picture
          to have better results.
          <br />
          <span className={styles.hey}>IMPORTANT!</span> The picture you take
          with your device is NOT saved anywhere by default, neither in the
          server or client file system. Also, using this option the MichiCard
          Will NOT be saved in the Browser's Local Storage.
          <br />
        </details>
        or
        <br />
        <details>
          ...
          Just press 'Get random picture' button to see the kitty cat that will
          be in the new Michi Card.
          <br />
        ...
        <br /> <span className={styles.hey}>IMPORTANT!</span>
        <br />
        If you don't load a picture or preview an image, the new Michi Card will
        not be created.
        <br />
        The last option You choose for the picture, is the one that will
        display.
        <br />
        <br />
        Once the above information is complete, press the 'Create!' button to
        see the new created Michi Card <FontAwesomeIcon icon={faShieldCat} />
        <br />
        Now You can take a screenshot to save the new Michi Card on your device!
        <br />
        <br />
        <span className={styles.hey}>Note:</span> to create a New Michi Card,
        after created one, press the icon to the right of Michi's name to go
        back to the Create Michi Card section.
      </details>

      <details>
        <summary>Feral cards</summary>
        What is a Feral Card?
        <br />
        A Feral Card is one that is different from the 'regular' card created
        with the app. The 'regular' Michi Cards have a specific design: Pink
        background, Michi's name and double border of the card in black, and the
        icon on the card is <FontAwesomeIcon icon={faShieldCat} />
        <br />
        ...
        beautiful 'regular' card, but...
        <br />
        ...if it is greater than 976 you obtain a 'Half Star' type Feral Card.
        This type of card is very similar to the 'regulars', but its background
        is of a nice blue and a 'Half Star' icon appears next to the Michi's
        name <FontAwesomeIcon icon={faStarHalfStroke} />
        <br />
        The probability of obtaining one of these cards is 2.39% each time a
        Michi Card is created.
        <br />
        <br />
        ...but if the number is <span className={styles.hey}>
          exactly 6
        </span>{" "}
        You will get a 'Full Star' card, which has a black background, a white
        border and a 'Full Star' icon <FontAwesomeIcon icon={faStar} /> next to
        Michi's name.
        <br />
      ...
      <details>
        ...
        collections.
        <br />I found the{" "}
        <span className={styles.hey}>Cool kitten wearing sunglasses</span> many
        years ago on Google doing another project with cats. Currently I can't
        find its source. The initial loading animation was achieved thanks to{" "}
      ...
      <details>
        ...
        With this new version of the MichiCards web app, the cards that are
        ...
        Storage of your browser. Also, You can delete individually the cards You
        don't want more in your Local Storage. Once the card is deleted, is gone
        forever.
        <br />
      </details>
      ...
      <details>
        ...
        accessing and using our web app, you agree to comply with these Terms of
        Use.
        <br />
        <br />
        ...
        their browser, using buttons and text fields, and take photos with their
        camera. The created cards are only stored in the browser's local storage
        and are not visible to other users unless the user voluntarily shares
        them.
        <br />
        <br />
        ...
        are not stored on our servers; They are only stored in the local storage
        ...
        create and must ensure that it does not violate any laws or third-party
        rights.
        <br />
        <br />
        ...
        <a
          style={{ color: "red" }}
          href="https://ariegonzaguer.netlify.app/"
          target="_blank"
        >
          {">"}Contact Page{"<"}
        </a>
        ...
        1. Introduction
        <br />
        This Privacy Policy describes how we handle and protect the information
        that is generated through our web app.
        <br />
        <br />
        2. Information Collected
        <br />
        We do not collect personal information from users. The only information
        stored is the created menu, which includes a description and statistics,
        and is saved in the browser's local storage.
        <br />
        <br />
        3. Use of Information
        <br />
        The information stored in local storage is used solely to allow users to
        access and modify their menus within their browser.
        <br />
        <br />
        4. Security
        <br />
        ...
        1. General
        <br />
        This web app is provided "as is" and "as available", without warranties
        of any kind.
        <br />
        <br />
        2. Responsibility
        <br />
        We are not responsible for any direct, indirect, incidental, special or
        consequential damages resulting from the use of this web app.
        <br />
        <br />
        3. Intellectual Property
        <br />
        ...
        <br />
        <br />
        4. Use of external sources
        <br />
        Users must comply with the terms of use of external sources used in the
        web app:
        <br />
        a.
        <a href="https://cataas.com/" target="_blank">
